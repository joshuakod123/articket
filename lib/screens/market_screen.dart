...
class MarketScreen extends StatelessWidget {
  ...
  static const _packs = [
    _Pack('빈티지 뮤지엄', '프레임 6종 · 스티커 24개', '₩2,500', Color(0xFF6B1F1A), '@paperjam'),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('크리에이터\n템플릿',
                          style:
                          AppText.display(size: 34, color: AppColors.ink)),
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(pack.creator,
                          style: AppText.data(
                              size: 9,
                              color: AppColors.stock.withValues(alpha: .8))),
                      Text(pack.name,
